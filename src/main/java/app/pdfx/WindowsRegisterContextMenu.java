...
public class WindowsRegisterContextMenu {
    ...
    public static String exePath() throws Exception {
        ...
        String exePath = thisJarDir + File.separator + "pdfxMetadataEditor.exe";
        if (new File(exePath).exists()) {
            return exePath;
        }
        exePath = thisJarDir + File.separator + "..\\pdfxMetadataEditor.exe";
        if (new File(exePath).exists()) {
            return exePath;
        }
    ...
    public static String applicationKey() {
        return "SOFTWARE\\Classes\\pdfxMetadataEditor";
    }
    ...
    public static void register() throws Exception {
        ...
        setRegistryKey(WinReg.HKEY_CURRENT_USER, shellKey, "", "PDFx Metadata Editor");
        setRegistryKey(WinReg.HKEY_CURRENT_USER, shellCommandKey, "", exePath);
        setRegistryKey(WinReg.HKEY_CURRENT_USER, shellDdeExecKey, "", "\"%1\"");
        setRegistryKey(WinReg.HKEY_CURRENT_USER, shellDdeExecApplicationKey, "", "pdfxMetadataEditor");
        ...
        for (CommandDescription desc : CommandDescription.batchCommands) {
            ...
            setRegistryKey(WinReg.HKEY_CURRENT_USER, batchShellDdeExecApplicationKey, "", "pdfxMetadataEditor");
        }
    }
