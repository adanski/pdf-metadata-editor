...
public class PreferencesWindow extends JDialog {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                PreferencesWindow frame = new PreferencesWindow(Preferences.userRoot().node("pdfxMetadataEditor"),
                        null);
    ...
    public PreferencesWindow(final Preferences prefs, MetadataInfo defaultMetadata, final Frame owner) {
        ...
        onsaveCopyDocumentTo.addActionListener(e -> {
        ...
        onsaveCopyXmpTo.addActionListener(e -> {
        ...
        comboBox.addActionListener(e -> showPreview((String) getRenameTemplateCombo().getModel().getSelectedItem()));
        ...
        txtpnEnterLicenseInformation.addHyperlinkListener(e -> {
        ...
        SwingUtilities.invokeLater(() -> lblNewLabel_1
                .setIcon(new ImageIcon(PreferencesWindow.class.getResource("/app/pdfx/os_integration_hint.png"))));
